...
if __name__ == '__main__':
    ...
    robot_1=MessageMonitor.setRobotName("tb3_0")
    robot_2=MessageMonitor.setRobotName("tb3_1")

    robot_2.setConfig(token="qJ0dEL_H_O0myzX1TQC2ZcAW0GY7ZnXBGMeaItwVQdVPWfCwbP93z-qfw8ENtMap1ta05nC2og9qyeA7gpuqpQ==", org="UTM", url="http://127.0.0.1:8086", bucket="rosdata")
       # all three methods are possible to specify the influxdb settings:
    robot_1.setConfig(token="qJ0dEL_H_O0myzX1TQC2ZcAW0GY7ZnXBGMeaItwVQdVPWfCwbP93z-qfw8ENtMap1ta05nC2og9qyeA7gpuqpQ==", org="UTM", url="http://127.0.0.1:8086", bucket="rosdata")
    ...
    v = robot_1.geometry_msgs_twist("/tb3_0/cmd_vel", geometry_msgs.Twist, on_change=True, skip_robot_name_tag=True)
    w = robot_2.geometry_msgs_twist("/tb3_1/cmd_vel", geometry_msgs.Twist, on_change=True, skip_robot_name_tag=True)
    ...
    # ab = my_laser_scan_class("/tb3_0/scan", sensor_msgs.LaserScan, update_period=5, on_change=True)
    # ac = my_laser_scan_class("/tb3_0/scan", sensor_msgs.LaserScan, update_period=5, on_change=True)

    # ac = MessageMonitor.sensor_msgs_jointstates("/test/jointstates", sensor_msgs.JointState, update_period = 1, on_change=False)

    ad = robot_1.nav_msgs_odometry("/tb3_0/odom", nav_msgs.Odometry, update_period=1, on_change=False)
    ae = robot_2.nav_msgs_odometry("/tb3_1/odom", nav_msgs.Odometry, update_period=1, on_change=False)
